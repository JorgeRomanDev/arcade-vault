...
function MiniCard({ game, onClick }: MiniCardProps) {
  return (
    ...
    <div className="home fade-in">
      ...
      <section className="home-section reveal">
        ...
        <div style={{ textAlign: 'center', marginTop: 24 }}>
          <button className="btn lg" onClick={() => navigate({ name: 'games' })}>VER TODOS LOS JUEGOS →</button>
        </div>
      </section>
      ...
      <section className="home-final reveal">
        ...
        <button className="btn xl pulse final-cta" onClick={() => navigate({ name: 'games' })}>INSERTAR MONEDA →</button>
